...
const CheckinPreviewPanel = ({ imageSrc, onRetake, onConfirm }) => {
  return (
    <div className="rounded-2xl border border-[#1E293B] bg-white overflow-hidden shadow-[8px_8px_0px_0px_#E2E8F0]">
      <div className="border-b border-[#1E293B] px-6 py-5">
        <h2 className="text-base font-bold">📷 Preview Foto</h2>
      ...
      <div className="flex flex-col items-center p-10">
        ...
        <div className="flex justify-center gap-4">
          ...
          <button
            onClick={onConfirm}
            className="flex items-center gap-2 rounded-full border-2 border-[#1E293B] bg-emerald-400 px-6 py-3 text-sm font-bold text-[#1E293B] shadow-[3px_3px_0px_0px_#1E293B] transition-all hover:-translate-y-0.5"
          >
            <FiCheck size={16} />
            Konfirmasi
          </button>
